...
if not os.path.exists('plots_without_toxic_seno'):
    os.makedirs('plots_without_toxic_seno')
...
def run_parameter_study():
    ...
    senolytic_concs = [0, 5, 10, 15]  # Senolytic concentrations
    ...
    for seno_idx, senolytic_conc in enumerate(senolytic_concs):
        for stem_idx, stem_cell_rate in enumerate(stem_cell_rates):
            ...
            # Save the figure
            filename = f"plots_without_toxic_seno/senolytic_{senolytic_conc}_stem_{stem_cell_rate}.png"
